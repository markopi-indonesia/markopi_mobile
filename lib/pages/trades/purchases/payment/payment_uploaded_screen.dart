...
class PaymentUploadedProofScreen extends StatefulWidget {
  @override
  _PaymentUploadedProofScreenState createState() =>
      _PaymentUploadedProofScreenState();
}

class _PaymentUploadedProofScreenState
    extends State<PaymentUploadedProofScreen> {
  @override
        ...
        child: Container(
          ...
          child: MolButton(context).blueButton(
              onPressed: () => Navigator.pushNamedAndRemoveUntil(
                  context, AppRoute.HOME_ROUTE, (r) => false),
              child: Text(
                "Beranda",

                  ...
                  children: <Widget>[
                      ...
                      child: InkWell(
                        onTap: () {
                          if (int.parse(productAmountCon.text) != 1) {
                            productAmountCon.text =
                                (int.parse(productAmountCon.text) - 1)
                                    .toString();
                          }
                          setState(() {});
                        },
                    ...
                    Expanded(
                      ...
                      child: InkWell(
                        onTap: () {
                          productAmountCon.text =
                              (int.parse(productAmountCon.text) + 1).toString();
                          setState(() {});
                        },
                        child: Container(
                          height: 25,
                          ...
                          decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border: Border.all(
                                  color: CustomColor.accentColor, width: 1)),
                          child: Center(
                            child: Icon(
                              Icons.add,
            ...
            Container(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    Converter().priceFormat(
                        double.parse(productAmountCon.text) * 75000),
                    style: Style14Blue,
                  ),
                ],
              ),

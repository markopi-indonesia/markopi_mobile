...
class PurchaseAddAddressScreen extends StatefulWidget {
  ...
  const PurchaseAddAddressScreen({Key key, this.twoAddress = false})
      : super(key: key);
  @override
  _PurchaseAddAddressScreenState createState() =>
      _PurchaseAddAddressScreenState();
}
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          _addressFields(
              "Nomor Telepon", phoneNumCon, "Contoh : 6212312316576"),
        ],
      ),

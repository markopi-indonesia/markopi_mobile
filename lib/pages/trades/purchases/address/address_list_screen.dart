...
class PurchaseAddressListScreen extends StatefulWidget {
  ...
  const PurchaseAddressListScreen(
      {Key key, this.hasAddress = false, this.hasTwoAddress = false})
      : super(key: key);

  @override
  _PurchaseAddressListScreenState createState() =>
      _PurchaseAddressListScreenState();
}
      ...
      onWillPop: () async {
        if (widget.hasAddress) {
          Navigator.pushReplacementNamed(
              context, AppRoute.PURCHASE_DETAIL_ROUTE,
              arguments: {"hasAdress": true});
          return false;
        }
        ...
        floatingActionButton: Container(
          ...
          child: MolButton(context).blueButton(
              onPressed: () => widget.hasAddress
                  ? Navigator.pushReplacementNamed(
                      context, AppRoute.PURCHASE_ADD_ADDRESS_ROUTE,

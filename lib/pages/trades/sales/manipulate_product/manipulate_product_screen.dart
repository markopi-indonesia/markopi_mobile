...
class ManipulateProductScreen extends StatefulWidget {
  ...
  @override
  ManipulateProductScreenState createState() =>
      ManipulateProductScreenState(this.isEdit);
}

class ManipulateProductScreenState extends State<ManipulateProductScreen>
  ...
  Widget _bottomButton() {
    return Container(
      ...
      child: tabController.index == 0
          ? MolButton(context).blueButton(
              onPressed: _nextButtonHandle,
              child: Center(
                  child: Text(
                "Selanjutnya",
                style: Style16WhiteBold,
              )),
            )
          : Row(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Center(
                      child: Text(
                    widget.isEdit ? "Ubah Penjualan" : "Buat Penjualan",
                    style: Style16WhiteBold,
                  )),
                )),
              ],
    ...
    showDialog(
        ...
        child: SimpleDialog(
          ...
          children: <Widget>[
            ...
            Text(
              widget.isEdit
                  ? "Apakah anda yakin akan mengubah penjualan?"
                  : "Apakah anda yakin untuk membuat penjualan ini?",
              style: Style12Black,
              textAlign: TextAlign.center,
            ),
                ...
                Container(
                  ...
                  child: MolButton(context).button(
                      ...
                      onPressed: () => Navigator.pushReplacementNamed(
                          context, AppRoute.PRODUCT_SUMMARY_ROUTE),
                      child: Text(
                        "Ya",
                        style: Style14White,
                      )),
